...
namespace CSS.Infrastructure.Migrations
{
    ...
    [Migration("20231019145929_V4_Add_ChatEntity")]
    partial class V4_Add_ChatEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CSS.Domains.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("48e7af65-d5cf-4560-bf76-fba1bd5caa11"),
                            CreationDate = new DateTime(2023, 10, 19, 21, 59, 29, 406, DateTimeKind.Local).AddTicks(8093),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = new Guid("926ff815-1846-4dc2-9d38-89a995e268c3"),
                            CreationDate = new DateTime(2023, 10, 19, 21, 59, 29, 406, DateTimeKind.Local).AddTicks(8123),
                            IsDeleted = false,
                            RoleName = "Student"
                        },
                        new
                        {
                            Id = new Guid("e8ae6817-fb79-4a64-9649-8a4a807bba28"),
                            CreationDate = new DateTime(2023, 10, 19, 21, 59, 29, 406, DateTimeKind.Local).AddTicks(8126),
                            IsDeleted = false,
                            RoleName = "Sponsor"
                        });
                });
