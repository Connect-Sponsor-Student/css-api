...
namespace CSS.Infrastructure.Migrations
{
    ...
    [Migration("20231020151436_FireBaseAuthen")]
    partial class FireBaseAuthen
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CSS.Domains.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a5b35b3e-f995-4552-8521-221bcc812eaf"),
                            CreationDate = new DateTime(2023, 10, 20, 22, 14, 36, 215, DateTimeKind.Local).AddTicks(6511),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = new Guid("5803fc81-085b-4720-a94c-9d883303d845"),
                            CreationDate = new DateTime(2023, 10, 20, 22, 14, 36, 215, DateTimeKind.Local).AddTicks(6525),
                            IsDeleted = false,
                            RoleName = "Student"
                        },
                        new
                        {
                            Id = new Guid("60202c83-6da5-4780-b6f7-10172c1a28fd"),
                            CreationDate = new DateTime(2023, 10, 20, 22, 14, 36, 215, DateTimeKind.Local).AddTicks(6526),
                            IsDeleted = false,
                            RoleName = "Sponsor"
                        });
                });
